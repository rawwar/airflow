...
* @throws ApiError
*/
export const ensureUseMetadataDbServiceGetGlobalStatsData = (queryClient: QueryClient, { includeRowCount }: {
  includeRowCount?: boolean;
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseMetadataDbServiceGetGlobalStatsKeyFn({ includeRowCount }), queryFn: () => MetadataDbService.getGlobalStats({ includeRowCount }) });
/**
* Get Table Stats
...
* @throws ApiError
*/
export const ensureUseMetadataDbServiceGetTableStatsData = (queryClient: QueryClient, { includeRowCount, tableName }: {
  includeRowCount?: boolean;
  tableName: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseMetadataDbServiceGetTableStatsKeyFn({ includeRowCount, tableName }), queryFn: () => MetadataDbService.getTableStats({ includeRowCount, tableName }) });
/**
...
* @throws ApiError
*/
export const ensureUseMetadataDbServiceGetSchemaIndexesEndpointData = (queryClient: QueryClient) => queryClient.ensureQueryData({ queryKey: Common.UseMetadataDbServiceGetSchemaIndexesEndpointKeyFn(), queryFn: () => MetadataDbService.getSchemaIndexesEndpoint() });
/**
...
* @throws ApiError
*/
export const ensureUseMetadataDbServiceGetTableIndexesEndpointData = (queryClient: QueryClient, { tableName }: {
  tableName: string;
}) => queryClient.ensureQueryData({ queryKey: Common.UseMetadataDbServiceGetTableIndexesEndpointKeyFn({ tableName }), queryFn: () => MetadataDbService.getTableIndexesEndpoint({ tableName }) });
/**
* Get Health
